...
- AI: groq API for natural language processing in the chatbot and DistilBERT for personalized investment suggestions.
...
- 🔹 Frontend: Angular
- 🔹 Backend: Python
- 🔹 Other: groq API / ChromaDB / FAISS / SerpAPI
